<nav x-data="{ open: false }" class="bg-orange-600 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl py-2 mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <h1 class="font-bold text-4xl mt-3 text-white">talabat</h1>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-xl font-semibold">
                        {{ __('Home') }}
                    </x-nav-link>
                    <x-nav-link :href="route('food.show')">
                        {{ __('Food') }}
                    </x-nav-link>
